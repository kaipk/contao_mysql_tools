...
$GLOBALS['TL_LANG']['mysql_tools']['description'] = 'Mit den MySQL Tools für Contao können Sie ihre Datenbank warten, optimieren oder im Notfall auch reparieren. Alle Wartungsbefehle sind MySQL interne Tools und werden über Queryies angesprochen. Daher benötigen Sie eine funktionierende Datenbankverbindung um den mit MySQLTools arbeiten zu können.';
$GLOBALS['TL_LANG']['mysql_tools']['warning'] = 'Bitte beachten Sie, dass bei falscher Bedienung dieser Extension unter Umständen irreparable Schäden an der Datenbank und somit an Ihrer Contao Webseite entstehen können. Wenn Sie sich nicht mit Datenbankwartung und SQL auskennen, sollten sie die Erweiterung nicht einsetzen und zuerst die Dokumentation lesen: <a href="http://dev.mysql.com/doc/refman/5.1/de/table-maintenance-sql.html">MySQL Dokumentation zur Tabellenwartung</a>';
